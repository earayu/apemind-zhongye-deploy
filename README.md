...
看到类似输出表示成功：
```
✔ Image docker.io/apecloud/apemind-enterprise:v2.3.37   Pulled
✔ Image docker.io/apecloud/apemind-enterprise-frontend:v2.3.37   Pulled
...
```
...
- 当前版本：`v2.3.37`
- 镜像来源：Docker Hub 公开镜像（`docker.io/apecloud/apemind-enterprise:v2.3.37`）
